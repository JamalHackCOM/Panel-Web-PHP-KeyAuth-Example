...
?>
			...
			<head>
				...
				<!-- End layout styles -->
				<link rel="shortcut icon" href="/img/logo0020.png" />
					...
					<div class="container-fluid page-body-wrapper">
						...
						<nav class="navbar p-0 fixed-top d-flex flex-row">
							<div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
								<a class="navbar-brand brand-logo-mini"><img src="/img/logo0020.png" alt="logo" /></a>
							</div>
								...
								<ul class="navbar-nav navbar-nav-right">
									...
									<li class="nav-item dropdown border-left">
										...
										<div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
											...
											<a class="dropdown-item preview-item">
												<div class="preview-thumbnail">
													<div class="preview-icon bg-dark rounded-circle"> <i class="mdi mdi-bell text-danger"></i> </div>
												</div>
												<div class="preview-item-content">
										...
										<div class="card">
											<div class="card-body">
												...
												<div class="row">
													...
													<div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right"> <i class="icon-lg mdi mdi-signal text-primary ms-auto"></i> </div>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="card">
											<div class="card-body">
												...
												<div class="row">
													<div class="col-8 col-sm-12 col-xl-8 my-auto">
														<div class="d-flex d-sm-block d-md-flex align-items-center">
															<h3 class="mb-0"><script>document.write(convertTimestamp(<?php echo $expiry; ?>));</script></h3> </div>
													</div>
													<div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right"> <i class="icon-lg mdi mdi-calendar text-danger ms-auto"></i> </div>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="card">
											<div class="card-body">
												...
												<div class="row">
													<div class="col-8 col-sm-12 col-xl-8 my-auto">
														<div class="d-flex d-sm-block d-md-flex align-items-center">
															<h3 class="mb-0"><script>document.write(convertTimestamp(<?php echo $lastLogin; ?>));</script></h3> </div>
													</div>
													<div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right"> <i class="icon-lg mdi mdi-account text-success ms-auto"></i> </div>
												</div>
											</div>
										</div>
									</div>
													...
													<table class="table">
														...
														<tbody>
															<tr>
																...
																<td> <img src="/img/usernull.png" alt="image" /> <span class="ps-2"><?php echo $username; ?></span> </td>
																<td>
																	<?php echo $ip; ?>
																</td>
																<td>
...
<center><button name="resethwid" class="btn btn-block btn-success btn-rad btn-lg"><i class="fas fa-redo-alt fa-sm text-white-50"></i> Reset HWID</button></center></form>';
        ...
        ?>
									...
									<div class="col-md-6 col-xl-4 grid-margin stretch-card">
										<div class="card">
											<div class="card-body">
												<h4 class="card-title">UI_MrGarabato</h4>
												<div class="owl-carousel owl-theme full-width owl-carousel-dash portfolio-carousel" id="owl-carousel-basic">
													<div class="item"> <img src="/img/270.png" alt=""> </div>
													<div class="item"> <img src="/img/271.png" alt=""> </div>
													<div class="item"> <img src="/img/272.png" alt=""> </div>
													<div class="item"> <img src="/img/273.png" alt=""> </div>
												</div>
															...
															<div class="preview-item-content d-flex flex-grow">
																<div class="flex-grow">
																	<div class="d-flex d-md-block d-xl-flex justify-content-between">
																		<h6 class="preview-subject">MrGarabato</h6>
																		<p class="text-muted text-small">5 Hours Ago</p>
																	</div>
																	<p class="text-muted">The best panel is UI_MrGarabato.</p>
																</div>
															</div>
														</div>
													</div>
											...
											<div class="card-body">
												<div class="card discord">
													<div class="discord-widget">
														...
														<div class="discord-body">
															...
															<a onclick="javascript:window.open(' https://discord.gg/mrgarabato ');">
												...
												if(discordjson != null) {
													function showMembersCount() {
														...
														var countElem = (document.getElementById("members-count").innerHTML = membersCount + "<span class='member-label'> Online Users<span>");
													}
