...
<head>
    ...
    <title>Change Log | ZetroCode</title>
    <!-- plugins:css -->
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="navbar p-0 fixed-top d-flex flex-row">
                <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
                    <a class="navbar-brand brand-logo-mini"><img src="../../../assets/img/logo02.png" alt="logo" /></a>
                </div>
                        ...
                        <div class="col-lg-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="col-12">
                                        <ul>
                                            <li class="mb-3"> <strong><span class="text-bold text-success">Current
                                                        version <?php echo $appVersion; ?></span></strong>
                                                <ul>
                                            ...
                                            <li class="mb-3"> <strong><span class="text-bold text-danger">version
                                                        1.9</span></strong>
                                                <ul>
                                                    ...
                                                    <li><span class="text-bold text-info">Initial Release Version
                                                            1.0</span></li>
                                                </ul>
                                            </li>
                                    </div>
