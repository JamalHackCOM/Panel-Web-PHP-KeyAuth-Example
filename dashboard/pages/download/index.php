...
?>
			...
			<head>
				...
				<title>Download | MrGarabato</title>
				<!-- plugins:css -->
								...
								<div class="row">
									<div class="col-md-12 grid-margin stretch-card">
										<div class="card">
											...
											{
											?>
																							<button class="btn btn-block btn-danger btn-rad btn-lg" onclick="doButton(this.value)" value="<?php echo $item->value; ?>">
																								<?php echo $item->text; ?>
																							</button>
																							<?php
											}
											?>
																					...
																					<div class="col-10" id="handshake"> <a onclick="handshake()" href="<?php echo $webdownload; ?>" style="color:white;" class="btn btn-block btn-success btn-rad btn-lg"><i class="fas fa-download fa-sm text-white-50"></i> Download</a> </div>
															</div>
														</div>
												</form>
												</div>
